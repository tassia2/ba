...
private:
  ...
  std::vector< DataType > L2_err_, H1_err_;
...
void PoissonTutorial::prepare_system() 
{
  ...
  // **************************
  // TODO exercise d)
  DirichletConstant bc_two(2.);
  compute_dirichlet_dofs_and_values(bc_two, space_, 0, dirichlet_dofs_, dirichlet_values_);
  // **************************
#else
