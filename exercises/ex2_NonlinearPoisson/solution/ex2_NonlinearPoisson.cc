...
{ 
  ...
  {
    this->kappa_ = initial_kappa + static_cast<DataType>(i) / static_cast<DataType>(num_steps-1) * (final_kappa - initial_kappa);
    LOG_INFO(1, "start Newton method for i = " << i << ", kappa = " << this->kappa_);  
