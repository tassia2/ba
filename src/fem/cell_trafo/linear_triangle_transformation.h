...
///
/// \class LinearTriangleTransformation linear_triangle_transformation.h
...
class LinearTriangleTransformation final: public CellTransformation< DataType, DIM > {
public:
  using Coord = typename CellTransformation< DataType, DIM >::Coord;
  using mat = typename CellTransformation< DataType, DIM >::mat;

  explicit LinearTriangleTransformation(CRefCellSPtr<DataType, DIM> ref_cell);
...
template < class DataType, int DIM >
LinearTriangleTransformation< DataType, DIM >::LinearTriangleTransformation(CRefCellSPtr<DataType, DIM> ref_cell)
...
template < class DataType, int DIM >
bool LinearTriangleTransformation< DataType, DIM >::differs_by_translation_from (CCellTrafoSPtr<DataType, DIM> rhs) const
{
...
template < class DataType, int DIM >
void LinearTriangleTransformation< DataType, DIM >::setup_transformation_matrix() 
{ 
...
template < class DataType, int DIM >
void LinearTriangleTransformation< DataType, DIM >::reinit(const std::vector<Coord >&coord_vtx) 
{
  CellTransformation< DataType, DIM >::reinit(coord_vtx);
  this->setup_transformation_matrix();
}
...
template < class DataType, int DIM >
bool LinearTriangleTransformation< DataType, DIM >::inverse_impl(const Coord& co_phy, Coord &co_ref) const {
