...
template < typename ValueType >
void CPUsimple_COO_lMatrix< ValueType >::VectorMult(
  ...
  if ((casted_invec == NULL) && (casted_outvec == NULL)) {
    LOG_ERROR("CPUsimple_COO_lMatrix<ValueType>::VectorMult unsupported in or "
              "out vector");
    this->print();
    invec.print();
    outvec->print();
...
template < typename ValueType >
void CPUsimple_COO_lMatrix< ValueType >::CastFrom(
...
template < typename ValueType >
void CPUsimple_COO_lMatrix< ValueType >::CastTo(
