...
template < typename ValueType >
void GPUcublas2_CSR_lMatrix< ValueType >::VectorMultAdd(
    const GPU_lVector< ValueType > &invec,
    GPU_lVector< ValueType > *outvec) const {
  LOG_ERROR("ERROR GPUcublas2_CSR_lMatrix<ValueType>::VectorMultAdd not "
            "implemented yet.");
}
...
void GPUcublas2_CSR_lMatrix< ValueType >::VectorMultNoDiag(
  ...
  LOG_ERROR("ERROR GPUcublas2_CSR_lMatrix<ValueType>::VectorMultNoDiag not "
            "implemented yet.");
}
