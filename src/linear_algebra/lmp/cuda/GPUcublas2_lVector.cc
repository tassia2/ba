...
template <> void GPUcublas2_lVector< double >::ArgMin(int *result) const {
#ifdef WITH_CUDA
...
template <> void GPUcublas2_lVector< float >::ArgMin(int *result) const {
#ifdef WITH_CUDA
  assert(this->get_size() > 0);
...
template <> void GPUcublas2_lVector< double >::ArgMax(int *result) const {
#ifdef WITH_CUDA
  assert(this->get_size() > 0);
...
template <> void GPUcublas2_lVector< float >::ArgMax(int *result) const {
#ifdef WITH_CUDA
  assert(this->get_size() > 0);
...
template <> void GPUcublas2_lVector< double >::Norm1(double *result) const {
#ifdef WITH_CUDA
  assert(this->get_size() > 0);
...
template <> void GPUcublas2_lVector< float >::Norm1(float *result) const {
#ifdef WITH_CUDA
  assert(this->get_size() > 0);
...
template <> void GPUcublas2_lVector< double >::Norm2(double *result) const {
#ifdef WITH_CUDA
  assert(this->get_size() > 0);
...
template <> void GPUcublas2_lVector< float >::Norm2(float *result) const {
#ifdef WITH_CUDA
  assert(this->get_size() > 0);
...
template < typename ValueType >
ValueType
GPUcublas2_lVector< ValueType >::Dot(const lVector< ValueType > &vec) const {
  ValueType result;
  Dot(vec, &result);
  return result;
}
...
void GPUcublas2_lVector< ValueType >::Dot(const lVector< ValueType > &vec,
  ...
  const GPU_lVector< ValueType > *casted_vec = nullptr;
...
template < typename ValueType >
void GPUcublas2_lVector< ValueType >::ScaleAdd(
    const ValueType scalar, const lVector< ValueType > &vec) {
  const GPU_lVector< ValueType > *casted_vec = nullptr;
...
template <> void GPUcublas2_lVector< double >::Scale(const double scalar) {
#ifdef WITH_CUDA
  assert(this->get_size() > 0);
...
template <> void GPUcublas2_lVector< float >::Scale(const float scalar) {
#ifdef WITH_CUDA
  assert(this->get_size() > 0);
...
void GPUcublas2_lVector< ValueType >::Rot(lVector< ValueType > *vec,
                                          const ValueType &sc,
                                          const ValueType &ss) {
  GPU_lVector< ValueType > *casted_vec = nullptr;
...
template <>
void GPUcublas2_lVector< double >::Rot(GPU_lVector< double > *vec,
...
template <>
void GPUcublas2_lVector< float >::Rot(GPU_lVector< float > *vec,
                                      const float &sc, const float &ss) {
#ifdef WITH_CUDA
  assert(this->get_size() > 0);
  assert(this->get_size() == vec->get_size());
