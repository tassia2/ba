...
template < typename ValueType >
void lMatrix< ValueType >::add_values(int num_entries, 
...
template < typename ValueType >
void lMatrix< ValueType >::get_row_values(const int row, ValueType *val) const {
  LOG_ERROR("lMatrix::get_row_values() does not support this matrix");
  this->print();
  quit_program();
}

template < typename ValueType >
int lMatrix< ValueType >::get_row_nnz(const int row) const {
  LOG_ERROR("lMatrix::get_row_nnz() does not support this matrix");
  this->print();
  quit_program();
}

template < typename ValueType >
int lMatrix< ValueType >::get_actual_nnz() const {
  LOG_ERROR("lMatrix::get_actual_nnz() does not support this matrix");
  this->print();
  quit_program();
}
...
template < typename ValueType >
void lMatrix< ValueType >::get_add_row_sums (ValueType *values) const
{
  LOG_ERROR("lMatrix::get_add_row_sums() does not support this matrix");
  this->print();
  quit_program();
}
...
template < typename ValueType >
void lMatrix< ValueType >::set_diagelements(const ValueType* vals) {
  LOG_ERROR("lMatrix::set_diagelements() does not support this matrix");
  this->print();
  quit_program();
}

template < typename ValueType >
void lMatrix< ValueType >::get_diagelements(ValueType* vals) const {
  LOG_ERROR("lMatrix::get_diagelements() does not support this matrix");
  this->print();
  quit_program();
}
