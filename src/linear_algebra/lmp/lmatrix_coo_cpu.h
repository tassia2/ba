...
public:
  ...
  virtual void TransformFromCSR(const int *Ap, const int *Aj,
                                const ValueType *Ax, const int num_rows,
...
public:
  ...
  CPUsimple_COO_lMatrix(int init_nnz, int init_num_col, int init_num_row,
...
public:
  ...
  CPUopenmp_COO_lMatrix(int init_nnz, int init_num_row, int init_num_col,
                        std::string init_name);
