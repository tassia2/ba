...
template void memcpyhost< double >(double *dest, const double *src,
                                   const size_t size);
template void memcpyhost< float >(float *dest, const float *src,
                                  const size_t size);
template void memcpyhost< int >(int *dest, const int *src, const size_t size);
template void memcpyhost< short int >(short int *dest, const short int *src,
                                      const size_t size);
