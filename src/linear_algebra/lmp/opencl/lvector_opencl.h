...
public:
  ...
  virtual void Axpy(const lVector< ValueType > &vec, const ValueType scalar);
  ...
  virtual void Rot(OPENCL_lVector< ValueType > *vec, const ValueType &sc,
                   const ValueType &ss);

  virtual void Rotg(ValueType *sa, ValueType *sb, ValueType *sc,
                    ValueType *ss) const;

  virtual void Rotm(lVector< ValueType > *vec, const ValueType &sparam);

  virtual void Rotm(OPENCL_lVector< ValueType > *vec, const ValueType &sparam);
