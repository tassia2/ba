...
template < typename ValueType >
void CPUopenmp_COO_lMatrix< ValueType >::CloneFrom(
...
template < typename ValueType >
void CPUopenmp_COO_lMatrix< ValueType >::VectorMult(
  ...
  if ((casted_invec == NULL) && (casted_outvec == NULL)) {
    LOG_ERROR("ERROR CPUopenmp_COO_lMatrix<ValueType>::VectorMult unsupported "
              "in or out vector");
    this->print();
    invec.print();
    outvec->print();
...
template < typename ValueType >
void CPUopenmp_COO_lMatrix< ValueType >::VectorMultAdd(
    const lVector< ValueType > &invec, lVector< ValueType > *outvec) const {
#ifdef WITH_OPENMP
  ...
  if ((casted_invec == NULL) && (casted_outvec == NULL)) {
    LOG_ERROR("ERROR CPUopenmp_COO_lMatrix<ValueType>::VectorMultAdd "
...
template < typename ValueType >
void CPUopenmp_COO_lMatrix< ValueType >::CastFrom(
...
template < typename ValueType >
void CPUopenmp_COO_lMatrix< ValueType >::CastTo(
...
template < typename ValueType >
void CPUopenmp_COO_lMatrix< ValueType >::VectorMultNoDiag(
