...
CPUopenmp_lVector< ValueType >::CPUopenmp_lVector(const int size,
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::CloneFrom(
...
template < typename ValueType >
ValueType
CPUopenmp_lVector< ValueType >::Dot(const CPU_lVector< ValueType > &vec) const {
#ifdef WITH_OPENMP
  ValueType dot = 0.0;
...
template < typename ValueType >
ValueType
CPUopenmp_lVector< ValueType >::Dot(const lVector< ValueType > &vec) const {
#ifdef WITH_OPENMP
  ValueType dot = 0.0;
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::Axpy(const CPU_lVector< ValueType > &vec,
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::Axpy(const lVector< ValueType > &vec,
                                          const ValueType scalar) {
#ifdef WITH_OPENMP
  if (const CPU_lVector< ValueType > *casted_vec =
          dynamic_cast< const CPU_lVector< ValueType > * >(&vec)) {
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::ScaleAdd(
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::ScaleAdd(const ValueType scalar,
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::Rot(CPU_lVector< ValueType > *vec,
                                         const ValueType &sc,
                                         const ValueType &ss) {
#ifdef WITH_OPENMP
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::Rot(lVector< ValueType > *vec,
                                         const ValueType &sc,
                                         const ValueType &ss) {
#ifdef WITH_OPENMP
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::Rotg(ValueType *sa, ValueType *sb,
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::Rotm(CPU_lVector< ValueType > *vec,
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::Rotm(lVector< ValueType > *vec,
                                          const ValueType &sparam) {
#ifdef WITH_OPENMP
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::Rotmg(ValueType *sd1, ValueType *sd2,
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::ElementWiseMult(
...
template < typename ValueType >
void CPUopenmp_lVector< ValueType >::CastFrom(
