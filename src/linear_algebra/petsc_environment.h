...
/// Before any PETSc function will be called the initialize function must
/// called. This is typically done within the PETSc wrapper classes for Vec,
/// Mat, or KSP. The initialize and finalize functions are idempotent.
