 ...
 */
template < class LevelGenerator > class DirectInterpolation {
public:
  ...
  void operator()(ResultType &result, ConnectionType const &connection,
    ...
    for (IndexSet::const_iterator
      ...
      std::set_intersection(
          ...
          connection.coarse_variables.end(), std::inserter(Ci, Ci.end()));
      ...
      // Embrace j-independent factor by dividing the correction factor alpha =
      // sum_Ei(aik) / sum_Ci(aik) by diagonal element aii and change the sign
