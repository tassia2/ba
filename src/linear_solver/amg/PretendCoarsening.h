 ...
 */
template < class LevelGenerator > class PretendCoarsening {
public:
  ...
  PretendCoarsening(Settings const &settings) : settings_(settings) {}

  ConnectionType operator()(ResultType &result, MatrixType const &Af) const {
    return ConnectionType(settings_.coarse_variables, settings_.fine_variables,
