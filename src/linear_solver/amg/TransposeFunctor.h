...
template < class MatrixType > struct TransposeFunctor {

  void operator()(MatrixType &matrix) const { matrix.transpose_me(); }
};

/// For coupled matrices

template < class T > struct TransposeFunctor< hiflow::la::CoupledMatrix< T > > {
