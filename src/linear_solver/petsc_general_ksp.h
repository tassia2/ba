...
enum KSPType { CG, GMRES, FGMRES, PREONLY };

} // namespace petsc

/// @brief Wrapper class for general KSP implementations of PETSc

template < class LAD > class PETScGeneralKSP : public PETScLinearSolver< LAD > {
public:
  typedef typename LAD::MatrixType OperatorType;
  typedef typename LAD::VectorType VectorType;
  typedef typename LAD::DataType DataType;

  PETScGeneralKSP(const MPI_Comm &comm, const OperatorType &op,
