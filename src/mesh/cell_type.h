...
private:
  ...
  ///
  /// \details A BSharedPtr is used since a ScopedPtr has no copy constructor
  static std::vector< BSharedPtr< CellType >::Type > cell_types_;
  ...
  std::vector< BSharedPtr< RefinementTree >::Type > refinement_trees_;
};
