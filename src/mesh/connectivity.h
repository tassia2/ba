...
public:
  ...
  void transpose(const EntityCount num_d1_entities,
...
public:
  ...
  static void
  intersect_subset_equal_dimensions(const SortedArray< int > &d_indices,
...
#endif
  static void
  intersect_subset_unequal_dimensions(const SortedArray< int > &d1_indices,
