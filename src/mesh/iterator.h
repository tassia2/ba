...
class EntityIterator
    : public boost::iterator_facade< EntityIterator, const Entity,
                                     boost::forward_traversal_tag > {
public:
  EntityIterator() : index_(-1) {}
...
class IncidentEntityIterator
    : public boost::iterator_facade< IncidentEntityIterator, const Entity,
                                     boost::forward_traversal_tag > {
public:
  IncidentEntityIterator() {}

  IncidentEntityIterator(const Entity &entity,
                         std::vector< EntityNumber >::const_iterator index_it)
