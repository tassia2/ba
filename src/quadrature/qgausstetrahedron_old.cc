...
QuadratureGaussTetrahedron< DataType >::QuadratureGaussTetrahedron()
  ...
  DataType y1[] = {.25};
  DataType z1[] = {.25};
  DataType w1[] = {.166666666666666666666666666667};
  ...
  // ---------------------------------------------
  size = 5;
  DataType x5[] = {.166666666666666666666666666667,
                   .166666666666666666666666666667,
                   .166666666666666666666666666667, .25, .5};
  DataType y5[] = {.166666666666666666666666666667,
                   .166666666666666666666666666667, .5, .25,
                   .166666666666666666666666666667};
  DataType z5[] = {.166666666666666666666666666667, .5,
                   .166666666666666666666666666667, .25,
                   .166666666666666666666666666667};
  DataType w5[] = {.075, .075, .075, -.133333333333333333333333333337, .075};
  ...
  DataType z15[] = {.25,
                    ...
                    .361803398874989484820458683437};
  DataType w15[] = {
      .019753086419753086419753086420, .011989513963169770001730642485,
      .011989513963169770001730642485, .011989513963169770001730642485,
      .011989513963169770001730642485, .011511367871045397546770239349,
      .011511367871045397546770239349, .011511367871045397546770239349,
      .011511367871045397546770239349, .008818342151675485008818342152,
      .008818342151675485008818342152, .008818342151675485008818342152,
      .008818342151675485008818342152, .008818342151675485008818342152,
...
template < class DataType >
QuadratureGaussTetrahedron< DataType > *
