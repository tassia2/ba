...
QuadratureGaussTriangle< DataType >::QuadratureGaussTriangle()
  ...
  DataType x1[] = {.333333333333333333333333333333};
  DataType y1[] = {.333333333333333333333333333333};
  DataType w1[] = {.5};
  ...
  DataType x3[] = {.166666666666666666666666666667,
                   .166666666666666666666666666667,
                   .666666666666666666666666666667};
  DataType y3[] = {.166666666666666666666666666667,
                   .666666666666666666666666666667,
                   .166666666666666666666666666667};
  DataType w3[] = {.166666666666666666666666666667,
                   .166666666666666666666666666667,
                   .166666666666666666666666666667};
  ...
  DataType x4[] = {.2, .333333333333333333333333333334, .6, .2};
  DataType y4[] = {.2, .333333333333333333333333333334, .2, .6};
  DataType w4[] = {.260416666666666666666666666667, -0.28125,
...
template < class DataType >
QuadratureGaussTriangle< DataType > *
