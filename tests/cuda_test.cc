...
template < class MatrixType, class VectorType > struct TestFunctor {
...
void GPUscalar_CSR_lMatrix_VectorMult() {
  std::cout << "\nscalar...\n";
  TestFunctor< GPUscalar_CSR_lMatrix< double >, GPUblas_lVector< double > >()();
  std::cout << "... passed\n";
}

void GPUscalartex_CSR_lMatrix_VectorMult() {
  std::cout << "\nscalartex\n";
  TestFunctor< GPUscalartex_CSR_lMatrix< double >,
               GPUblas_lVector< double > >()();
  std::cout << "... passed\n";
}

void GPUcublas2_CSR_lMatrix_VectorMult() {
  std::cout << "\ncublas2\n";
  TestFunctor< GPUcublas2_CSR_lMatrix< double >,
               GPUcublas2_lVector< double > >()();
  std::cout << "... passed\n";
}

BOOST_AUTO_TEST_CASE(cuda) {

  GPUscalar_CSR_lMatrix_VectorMult();
  GPUscalartex_CSR_lMatrix_VectorMult();
  GPUcublas2_CSR_lMatrix_VectorMult();
