...
#define BOOST_TEST_MODULE parallel_matrix
...
BOOST_AUTO_TEST_CASE_TEMPLATE(add_get_value, T, MyTypeList) {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(set_value, T, MyTypeList) {
  MPI_Comm comm(MPI_COMM_WORLD);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(set_values, T, MyTypeList) {
  MPI_Comm comm(MPI_COMM_WORLD);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(vector_mult_diag, T, MyTypeList) {
  MPI_Comm comm(MPI_COMM_WORLD);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(vector_mult_with_offdiag, T, MyTypeList) {
  MPI_Comm comm(MPI_COMM_WORLD);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(diagonalize_rows, T, MyTypeList) {
  MPI_Comm comm(MPI_COMM_WORLD);
