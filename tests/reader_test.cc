...
BOOST_AUTO_TEST_CASE(reader) {
  ...
  std::string filename_vtk =
      std::string(datadir) + std::string("unitcube_refinementlevel_3.vtu");
  std::string filename_ucd =
      std::string(datadir) + std::string("unit_cube.inp");
  ...
  for (EntityIterator it = mesh_ucd->begin(tdim); it != mesh_ucd->end(tdim);
       ++it) {
  ...
  for (EntityIterator it = mesh_ucd->begin(tdim - 1);
       it != mesh_ucd->end(tdim - 1); ++it) {
    std::cout << *it << std::endl;
  }
  std::cout << "\n\n";
  ...
  for (EntityIterator it = mesh_ucd->begin(tdim - 2);
       it != mesh_ucd->end(tdim - 2); ++it) {
    std::cout << *it << std::endl;
  }
  std::cout << "\n\n";

  std::cout << "iteration over cells of mesh_vtk:\n";
  for (EntityIterator it = mesh_vtk->begin(tdim); it != mesh_vtk->end(tdim);
       ++it) {
    std::cout << *it << std::endl;
  }
  std::cout << "\n\n";
  ...
  for (EntityIterator it = mesh_vtk->begin(tdim - 1);
       it != mesh_vtk->end(tdim - 1); ++it) {
    std::cout << *it << std::endl;
  }
  std::cout << "\n\n";
  ...
  for (EntityIterator it = mesh_vtk->begin(tdim - 2);
       it != mesh_vtk->end(tdim - 2); ++it) {
    std::cout << *it << std::endl;
  }
  std::cout << "\n\n";
